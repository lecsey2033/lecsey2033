...
| [CPP4_3DViewer_v2.0](https://github.com/lecsey2033/CPP4_3DViewer_v2.0-1)| A program for rendering a 3D model based on .obj files with the ability to change the rendering characteristics. And also creating screenshots and gif animations (in progress)|  C++, Makefile, Qt, OpenGL, gtest.h, OOP, patterns: MVC|
